...
public class Board extends JPanel{
    ...
    Image superDotTopLeft = Toolkit.getDefaultToolkit().getImage("img/guillaume.png");
    Image superDotTopRight = Toolkit.getDefaultToolkit().getImage("Epitech_Simulator/img/Guilhem.png");
    Image superDotBottomLeft = Toolkit.getDefaultToolkit().getImage("Epitech_Simulator/img/fabien.png");
    Image superDotBottomRight = Toolkit.getDefaultToolkit().getImage("Epitech_Simulator/img/Joshua.png");
    Image superDotMiddle=Toolkit.getDefaultToolkit().getImage("Epitech_Simulator/img/lois.png");


    Image titleScreen= Toolkit.getDefaultToolkit().getImage("Epitech_Simulator/img/titleScreen.png");
    Image Over= Toolkit.getDefaultToolkit().getImage("Epitech_Simulator/img/Gameover.png");
    Image Win= Toolkit.getDefaultToolkit().getImage("Epitech_Simulator/img/Win.jpeg");
    //fantome
    Image red_ghost=Toolkit.getDefaultToolkit().getImage("Epitech_Simulator/img/paulD.png");
    Image red_ghost2=Toolkit.getDefaultToolkit().getImage("Epitech_Simulator/img/paulG.png");
    Image[] G_red={red_ghost,red_ghost2};

    Image yellow_ghost=Toolkit.getDefaultToolkit().getImage("Epitech_Simulator/img/julienD.png");
    Image yellow_ghost2=Toolkit.getDefaultToolkit().getImage("Epitech_Simulator/img/julienG.png");
    Image[] G_yellow={yellow_ghost,yellow_ghost2};

    Image blue_ghost=Toolkit.getDefaultToolkit().getImage("Epitech_Simulator/img/alexD.png");
    Image blue_ghost2=Toolkit.getDefaultToolkit().getImage("Epitech_Simulator/img/alexG.png");
    Image[] G_blue={blue_ghost,blue_ghost2};

    Image pink_ghost=Toolkit.getDefaultToolkit().getImage("Epitech_Simulator/img/QuentinD.jpg");
    Image pink_ghost2=Toolkit.getDefaultToolkit().getImage("Epitech_Simulator/img/QuentinG.jpg");
    Image[] G_pink={pink_ghost,pink_ghost2};

    //pacman
    Image pacmanImage=Toolkit.getDefaultToolkit().getImage("Epitech_Simulator/img/pacman.jpg");

    Image pacman_left=Toolkit.getDefaultToolkit().getImage("Epitech_Simulator/img/pacmanleft.jpg");
    Image pacman_right=Toolkit.getDefaultToolkit().getImage("Epitech_Simulator/img/pacmanright.jpg");
    Image pacman_up=Toolkit.getDefaultToolkit().getImage("Epitech_Simulator/img/pacmanup.jpg");
    Image pacman_down=Toolkit.getDefaultToolkit().getImage("Epitech_Simulator/img/pacmandown.jpg");
    ...
    public Board(){
        ...
        playAgainButton.setBounds(150, 250, 120, 40); // Adjust size and position as needed
    ...
    public void resetGame() {
        // Reset game state here (lives score positions ...
        title = true;
        lives = 3;
        score = 0;
        init();
    ...
    public void checkSuperDotCollisions() {
    ...
    public void paint(Graphics g){
        ...
        // Draw Pacman with mouth open based on the direction
            g.drawImage(Pacman_images[pacman.index], pacman.x, pacman.y, null);
        } else {
        // Draw Pacman with mouth closed
            g.drawImage(pacmanImage, pacman.x, pacman.y, null);
    }
